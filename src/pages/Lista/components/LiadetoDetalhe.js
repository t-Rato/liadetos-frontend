		...
		>
			...
			>
				...
				<div className="flex flex-col gap-2 text-gray-600 text-sm lg:text-base">
					<p><span className="font-semibold text-black">Autor:</span> {liadeto.autor?.dadosUsuario?.isOther ? liadeto.autorId === 10 ? "Nam lembro" : "Outro indivíduo" : liadeto.autor?.dadosUsuario?.alcunha || "Outro indivíduo"}</p>
